...
# 1b) Zaawansowany CSS, aby kontener główny zajmował 100% szerokości i wysokości oraz korzystał z Flexbox
st.markdown(
    """
    <style>
    html, body, .block-container, .main, .streamlit-expanderHeader {
        height: 100vh;
        width: 100vw;
        margin: 0;
        padding: 0;
    ...
    /* Upewniamy się, że główny tytuł również rozciąga się na pełną szerokość */
    .css-1d391kg {
        flex: 1;
    }
    </style>
